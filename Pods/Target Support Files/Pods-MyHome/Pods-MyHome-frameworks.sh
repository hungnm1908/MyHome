...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CKCalendar/CKCalendar.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/InfinitePagingView/InfinitePagingView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UIBarButtonItem-Badge-Coding/UIBarButtonItem_Badge_Coding.framework"
