...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([arrayBookDate containsObject:date]) {
        ...
        if ([self checkIsLockFromDate:date]) {
            ...
            cell.labelStatusRoom.text = [NSString stringWithFormat:@"Trạng thái phòng: %@",dict[@"BOOK_STATUS_NAME"]];
        }
...
- (void)unlockRoom : (id)sender {
    [Utils alert:@"Mở khóa phòng" content:@"Bạn chắc chắn muốn mở khóa phòng ?" titleOK:@"Đồng ý" titleCancel:@"Hủy bỏ" viewController:nil completion:^{
